...
generate('contracts/test/ProofOfAuthority.sol/ProofOfAuthority.json', 'ProofOfAuthority')
...
generate('contracts/DefaultBLSAccountRegistry.sol/DefaultBLSAccountRegistry.json', 'DefaultAccountRegistry')
