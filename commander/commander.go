...
func (c *Commander) Start() (err error) {
	...
	c.startWorker("Tracking Sent Txs", func() error { return c.startTrackingSentTxs() })
	c.startWorker("Sending Requesting Txs", func() error { return c.startSendingRequestedTxs() })
