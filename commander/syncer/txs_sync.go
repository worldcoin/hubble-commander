...
func (c *TxsContext) SyncBatch(batch eth.DecodedBatch) error {
...
func (c *TxsContext) syncExistingBatch(remoteBatch *eth.DecodedTxBatch, localBatch *models.Batch) error {
...
func (c *TxsContext) getTransactionSender(txHash common.Hash) (*common.Address, error) {
...
func (c *TxsContext) addTxCommitment(batch *eth.DecodedTxBatch, decodedCommitment *encoder.DecodedCommitment) error {
