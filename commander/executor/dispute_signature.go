...
func (t *TransactionExecutor) disputeTransferSignature(
	...
	return t.client.DisputeSignatureTransfer(&batch.ID, targetCommitmentProof, signatureProof, 6_000_000)
}
...
func (t *TransactionExecutor) disputeCreate2TransferSignature(
	...
	return t.client.DisputeSignatureCreate2Transfer(&batch.ID, targetCommitmentProof, signatureProof, 7_500_000)
}
