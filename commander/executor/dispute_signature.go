...
func (t *TransactionExecutor) disputeTransferSignature(
	...
	return t.client.DisputeSignatureTransfer(&batch.ID, targetCommitmentProof, signatureProof, t.cfg.SignatureDisputeGasLimit)
}
...
func (t *TransactionExecutor) disputeCreate2TransferSignature(
	...
	return t.client.DisputeSignatureCreate2Transfer(&batch.ID, targetCommitmentProof, signatureProof, t.cfg.SignatureDisputeGasLimit)
}
