...
func (s *TestSuiteWithExecutionContext) SetupExecutor(transactionType txtype.TransactionType) {
	s.executionCtx.Executor = CreateTransactionExecutor(transactionType)
}
