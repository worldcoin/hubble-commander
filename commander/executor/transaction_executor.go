...
type TransactionExecutor interface {
	...
	SubmitBatch(client *eth.Client, commitments []models.TxCommitmentWithTxs) (*types.Transaction, error)
}
...
func (e *TransferExecutor) SubmitBatch(client *eth.Client, commitments []models.TxCommitmentWithTxs) (*types.Transaction, error) {
...
func (e *C2TExecutor) SubmitBatch(client *eth.Client, commitments []models.TxCommitmentWithTxs) (*types.Transaction, error) {
