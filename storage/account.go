...
func (s *InternalStorage) AddAccountLeafIfNotExists(account *models.AccountLeaf) error {
	return s.Badger.Insert(account.PubKeyID, *account)
}

func (s *InternalStorage) GetAccountLeaf(pubKeyID uint32) (*models.AccountLeaf, error) {
...
func (s *InternalStorage) GetAccountLeaves(publicKey *models.PublicKey) ([]models.AccountLeaf, error) {
...
func (s *InternalStorage) GetPublicKey(pubKeyID uint32) (*models.PublicKey, error) {
...
func (s *InternalStorage) GetUnusedPubKeyID(publicKey *models.PublicKey, tokenID *models.Uint256) (*uint32, error) {
...
func (s *InternalStorage) GetPublicKeyByStateID(stateID uint32) (*models.PublicKey, error) {
