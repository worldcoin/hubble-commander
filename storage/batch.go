...
func (s *InternalStorage) AddBatch(batch *models.Batch) error {
...
func (s *InternalStorage) MarkBatchAsSubmitted(batch *models.Batch) error {
...
func (s *InternalStorage) GetMinedBatch(batchID models.Uint256) (*models.Batch, error) {
...
func (s *InternalStorage) GetBatch(batchID models.Uint256) (*models.Batch, error) {
	res := make([]models.Batch, 0, 1)
	err := s.Postgres.Query(
		s.QB.Select("*").
			From("batch").
...
func (s *InternalStorage) GetBatchByHash(batchHash common.Hash) (*models.Batch, error) {
	res := make([]models.Batch, 0, 1)
	err := s.Postgres.Query(
		s.QB.Select("*").
			From("batch").
...
func (s *InternalStorage) GetBatchByCommitmentID(commitmentID int32) (*models.Batch, error) {
	res := make([]models.Batch, 0, 1)
	err := s.Postgres.Query(
		s.QB.Select("batch.*").
			From("batch").
...
func (s *InternalStorage) GetLatestSubmittedBatch() (*models.Batch, error) {
	res := make([]models.Batch, 0, 1)
	err := s.Postgres.Query(
		s.QB.Select("*").
			From("batch").
...
func (s *InternalStorage) GetNextBatchID() (*models.Uint256, error) {
...
func (s *InternalStorage) GetLatestFinalisedBatch(currentBlockNumber uint32) (*models.Batch, error) {
	res := make([]models.Batch, 0, 1)
	err := s.Postgres.Query(
		s.QB.Select("*").
			From("batch").
...
func (s *InternalStorage) GetBatchesInRange(from, to *models.Uint256) ([]models.Batch, error) {
	qb := s.QB.Select("*").
		From("batch").
		OrderBy("batch_id")
...
func (s *InternalStorage) DeleteBatches(batchIDs ...models.Uint256) error {
	res, err := s.Postgres.Query(
		s.QB.Delete("batch").
