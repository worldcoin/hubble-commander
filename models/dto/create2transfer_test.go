...
func TestCreate2Transfer_MarshalJSON(t *testing.T) {
	...
	// nolint:goconst,lll
	expected := `{"Type":3,"FromStateID":1,"ToPublicKey":"","Amount":"50","Fee":"10","Nonce":"0","Signature":"0xdeadbeef"}`
