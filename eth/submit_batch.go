...
func (c *Client) SubmitTransfersBatch(commitments []models.TxCommitmentWithTxs) (
	*types.Transaction,
	error,
) {
...
func (c *Client) SubmitCreate2TransfersBatch(commitments []models.TxCommitmentWithTxs) (
	*types.Transaction,
	error,
) {
...
func (c *Client) SubmitTransfersBatchAndWait(commitments []models.TxCommitmentWithTxs) (*models.Batch, error) {
	return c.submitBatchAndWait(func() (*types.Transaction, error) {
		return c.SubmitTransfersBatch(commitments)
	})
}
func (c *Client) SubmitCreate2TransfersBatchAndWait(commitments []models.TxCommitmentWithTxs) (*models.Batch, error) {
	return c.submitBatchAndWait(func() (*types.Transaction, error) {
...
func (c *Client) packCommitments(method string, commitments []models.TxCommitmentWithTxs) ([]byte, error) {
